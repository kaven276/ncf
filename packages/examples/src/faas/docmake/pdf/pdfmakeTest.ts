...
// reference https://pdfmake.github.io/docs/0.1/fonts/standard-14-fonts/
...
export const faas = async () => {
  ...
  try {
    ...
    // return pdfDoc; // 直接返回生成的是文本格式，不能用PDF阅读器打开
    pdfDoc.pipe(createWriteStream(join(__dirname, 'document.pdf')));
    pdfDoc.end();
    return 'PDF created';
  } catch (e) {
    console.error(e);
